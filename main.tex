...
The current work has been implementing the stellar wind (See~\ref{sec:wind}) code and replicating the results of~\citet{1998ApJ...492..743M}. Their results were computed using the Sobolev approximation and were in agreement with~\citet{Hartmann:1994tl}.
